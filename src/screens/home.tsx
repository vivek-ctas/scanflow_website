  ...
  return (
    <Layout>
      <div className="pt-26 relative isolate overflow-hidden">
        ...
        <div className="pointer-events-none absolute -top-24 -left-24 -z-10 h-72 w-72 rounded-full bg-accent/15 blur-3xl animate-drift" />
        <div className="pointer-events-none absolute top-[28rem] -right-20 -z-10 h-80 w-80 rounded-full bg-ink/12 blur-3xl animate-drift [animation-delay:1.4s]" />
